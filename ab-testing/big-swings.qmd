...
date: "2025-08-29"
description: >
  Compares two strategies — guaranteed small wins vs. a single high-variance transformational
  bet — using 30,000 A/B test simulations. Big Swings run faster and generate far more
  average value.
...
![](./big-swings-assets/small.png){fig-alt="Expected treatment effects, small wins" width="100%" .framed}
...
![](./big-swings-assets/big.png){fig-alt="Expected treatment effects, transformational" width="100%" .framed}
...
labels = [str(v) for v in itc_values]
